...
def new_document(pt = 14, line_spacing = 1.15, font_name = 'Times New Roman', left_margin = 30, right_margin = 15, top_margin = 20, bottom_margin = 20):
    ...
    def adding_picture(name):
        with Image.open(r'C:\Users\AlABelugin\Desktop\Project\Words\Documents\\' + str(text[0][name])) as img:
            width, height = img.size
            img.save(r'C:\Users\AlABelugin\Desktop\Project\Words\Documents\\' + str(text[0][name]) , dpi=(800, 800))
        if width > 700:
            new_doc.add_picture(r'C:\Users\AlABelugin\Desktop\Project\Words\Documents\\' + str(text[0][name]), width = Mm(width/4.25), height = Mm(height/4.25))
        else:
            new_doc.add_picture(r'C:\Users\AlABelugin\Desktop\Project\Words\Documents\\' + str(text[0][name]), width = Mm(width/3.5), height = Mm(height/3.5))
        new_doc.paragraphs[-1].alignment = WD_ALIGN_PARAGRAPH.CENTER
        os.remove(r'C:\Users\AlABelugin\Desktop\Project\Words\Documents\\' + str(text[0][name]))

    def adding_footnotes(name):
        with open(r'C:\Users\AlABelugin\Desktop\Project\Words\Documents\\' + str(name[:name.find('.docx')]) + '.txt', 'r', encoding = 'utf8') as file:
            f = file.readlines()
            footnotes, summa = {}, 0
    ...
    if text[3]: docx2txt.process(r'C:\Users\AlABelugin\Desktop\Project\Words\Documents\\' + str(filename),r"C:\Users\AlABelugin\Desktop\Project\Words\Documents")
    ...
    save_name = r'C:\Users\AlABelugin\Desktop\Project\Words\New Documents\\'+ '_' + str(filename)
